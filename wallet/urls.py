...
from .views import DepositView, WithdrawalView, TransactionListView, VerifyDepositView, TransactPayWebhookView, NOWPaymentsWebhookView
...
urlpatterns = [
    ...
    re_path(r'^webhooks/transactpay/?$', TransactPayWebhookView.as_view(), name='transactpay-webhook'),
